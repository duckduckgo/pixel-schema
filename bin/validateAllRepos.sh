...
./bin/validateRepo.sh ../apple-browsers/macOS/PixelDefinitions/ $USER_MAP $ASANA_PROJECT
./bin/validateRepo.sh ../apple-browsers/iOS/PixelDefinitions/ $USER_MAP $ASANA_PROJECT
