...
const argv = yargs(hideBin(process.argv))
    .command(`$0 [${MAIN_DIR_ARG}] [pixelPrefix]`, 'Fetches pixel data from Clickhouse into a temporary CSV file', (yargs) => {
        return yargs.positional(MAIN_DIR_ARG, getMainDirPositional()).positional('pixelPrefix', {
